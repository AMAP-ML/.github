...
- **2026.02.04** [GPG](https://github.com/AMAP-ML/GPG) provides a simple group policy gradient baseline for model reasoning (ICLR 2026).
...
- **2025.06.20** [FluxText](https://github.com/AMAP-ML/FluxText) provides a diffusion transformer baseline for scene-text editing.
