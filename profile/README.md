...
<p align="center">
  <a href="https://github.com/AMAP-ML"><img src="https://img.shields.io/github/followers/AMAP-ML?label=Follow%20AMAP-ML&style=social" alt="Follow AMAP-ML"></a>
  <a href="https://github.com/AMAP-ML?tab=repositories"><img src="https://img.shields.io/badge/Explore-Open--source%20projects-1677ff" alt="Explore projects"></a>
  <a href="mailto:cxxgtxy@gmail.com"><img src="https://img.shields.io/badge/Join%20DreamX-Intern%20%2F%20Full--time-00a870" alt="Join DreamX"></a>
</p>
...
<p align="center">
  <a href="#flagship-releases">Flagship releases</a> ·
  <a href="#research-directions">Research directions</a> ·
  <a href="#recent-updates">Recent updates</a> ·
  <a href="#project-map">All projects</a> ·
...
<p align="center">
  ...
  <b>47</b> papers at major venues in 2026 &nbsp;·&nbsp;
  <b>3</b> core problems &nbsp;·&nbsp;
  <b>6</b> DreamX model and system families
</p>

<p align="center">
  Our work appears at <b>ICLR, CVPR, ECCV, ACL, AAAI, SIGGRAPH, IJCV, ICCV, ICML, KDD, EMNLP, ACM MM,</b> and <b>WWW</b>.
</p>
...
- **2026.05.18** — [MobilityBench](https://github.com/AMAP-ML/MobilityBench) is accepted to KDD 2026 as an Oral paper.

<details>
<summary><b>Earlier updates</b></summary>

- **2026.07.20** — The DreamX team adds four publications across SCALAR++ (IJCV), [Evaluation-Verification Reward](https://arxiv.org/abs/2607.29025) (SIGGRAPH Asia 2026), [MAR-GRPO](https://arxiv.org/abs/2604.06966), and [Peak-End-Net](https://arxiv.org/abs/2607.13941) (ACM MM 2026).
- **2026.05.12** — [CoEvolve](https://github.com/AMAP-ML/CoEvolve) introduces agent–data mutual evolution for training LLM agents (ACL 2026).
- **2026.05.12** — [Thinking-with-Map](https://github.com/AMAP-ML/Thinking-with-Map) strengthens geolocalization with reinforced, parallel map-augmented reasoning (ACL 2026 Findings).
...
- **2026.05.01** — [UniMRG](https://github.com/Sugewud/UniMRG) shows that multi-representation generation strengthens understanding in unified multimodal models (ICML 2026).
- **2026.05.01** — *Train-Free Infinite-Frame Generation*, *D-Evo*, and *EEPO* are accepted to ICML 2026.
- **2026.04.22** — [DCW](https://github.com/AMAP-ML/DCW) mitigates SNR-t bias and [EMF](https://github.com/AMAP-ML/EMF) advances text-conditioned one-step generation (CVPR 2026).
- **2026.04.10** — [SkillClaw](https://github.com/AMAP-ML/SkillClaw) releases an evolving skill library built from real interaction traces.
- **2026.04.01** — [MACE-Dance](https://github.com/AMAP-ML/MACE-Dance) releases a motion–appearance cascaded generation framework for music-driven dance video (SIGGRAPH 2026).
- **2026.03.23** — [Omni-WorldBench](https://github.com/AMAP-ML/Omni-WorldBench) releases a benchmark for dynamic 4D interactive world modeling.
- **2026.03.20** — [AutoDrive-R2](https://github.com/AMAP-ML/AutoDrive-R2) is accepted to ICLR 2026.
...
- **2026.03.11** — [RL3DEdit](https://github.com/AMAP-ML/RL3DEdit) uses geometry-guided reinforcement learning for multi-view-consistent 3D scene editing (ECCV 2026).
...
- **2026.02.06** — [SpatialGenEval](https://github.com/AMAP-ML/SpatialGenEval), [Tree-GRPO](https://github.com/AMAP-ML/Tree-GRPO), [Code2World](https://github.com/AMAP-ML/Code2World), and [GPG](https://github.com/AMAP-ML/GPG) release work on spatial evaluation, agent RL, GUI world models, and reasoning.
- **2025.10.22** — [Taming-Hallucinations](https://github.com/AMAP-ML/Taming-Hallucinations) reduces MLLM video hallucinations with counterfactual video generation.
- **2025.06.20** — [FluxText](https://github.com/AMAP-ML/FluxText) releases a diffusion-transformer baseline for scene-text editing.
</details>
...
The complete map of our public research artifacts, organized by their primary contribution to the spatial intelligence stack.

<details open>
<summary><b>Understand and predict the world</b></summary>
...
<details>
<summary><b>Generate and simulate the world</b></summary>
...
| [RL3DEdit](https://github.com/AMAP-ML/RL3DEdit) | Geometry-guided RL for multi-view-consistent 3D scene editing. | ECCV 2026 |
...
| [Omni-Effects](https://github.com/AMAP-ML/Omni-Effects) | Prompt-guided, spatially controllable composite visual-effects generation. | AAAI 2026 |
| [S2-Guidance](https://github.com/AMAP-ML/S2-Guidance) | Training-free stochastic self-guidance for diffusion models. | ICLR 2026 |
| [EPG](https://github.com/AMAP-ML/EPG) | Pixel-space generative modeling via self-supervised pre-training. | ICLR 2026 |
| [USP](https://github.com/AMAP-ML/USP) | Unified self-supervised pretraining in VAE space for diffusion models. | ICCV 2025 |
| [EMF](https://github.com/AMAP-ML/EMF) | Text-conditioned one-step image generation. | CVPR 2026 |
| [DCW](https://github.com/AMAP-ML/DCW) | Differential correction for SNR-t bias in diffusion probabilistic models. | CVPR 2026 |
| [NarrLV](https://github.com/AMAP-ML/NarrLV) | Narrative-centric evaluation for long-video generation models. | ICLR 2026 |
...
<details>
<summary><b>Shared foundations and evaluation</b></summary>
...
| [Evaluation-Verification Reward](https://arxiv.org/abs/2607.29025) | Fine-grained reward modeling for consistent multi-reference image editing. | SIGGRAPH Asia 2026 |
...
Please send your CV, representative work, and research interests to [cxxgtxy@gmail.com](mailto:cxxgtxy@gmail.com). You can also visit our [organization page](https://github.com/AMAP-ML) or [team homepage](https://cxxgtxy.github.io).
